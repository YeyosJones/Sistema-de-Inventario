...
if ($varrol == 'Editor') {
     ?> 
     "<script> window.location= 'client-listE.php' </script>";
     <?php
     die();
 }
if ($varrol == 'Visualizador') {
     ?> 
     "<script> window.location= 'client-listV.php' </script>";
     <?php
     die();
 }
?>
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="client-list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE EMPLEADOS</a>
					</li>
					<li>
						<a href="client-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR EMPLEADO</a>
					</li>
...
<tr class="text-center" >
	<td><?php echo $mostrar['empleado_numero'] ?></td>
	<td><?php echo $mostrar['empleado_nombre'] ?></td>
	<td><?php echo $mostrar['empleado_apellido'] ?></td>
    <td><?php echo $mostrar['empleado_apellido2'] ?></td>
    <td><?php echo $mostrar['empleado_area'] ?></td>
    <td><?php echo $mostrar['empleado_cargo'] ?></td>
    <td><?php echo $mostrar['empleado_telefono'] ?></td>
    <td><?php echo $mostrar['empleado_ext'] ?></td>
	<td><?php echo $mostrar['empleado_direccion'] ?></td>
    <td>
       <a href="client-update.php?id_employee=<?php echo $mostrar['id_employee'];?>" class="btn btn-success">
        <i class="fas fa-sync-alt"></i></a>
    </td>
    <td>
     <a href="eliminarl.php?id_employee=<?php echo $mostrar['id_employee'];?>" class="btn btn-warning"
