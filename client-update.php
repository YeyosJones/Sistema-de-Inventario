			...
			<div class="full-box nav-lateral-content">
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						...
						<li>
							<a href="company.php"><i class="fas fa-traffic-light"></i>&nbsp; Empresa</a>
						</li>
					</ul>
				</nav>
			</div>
...
?>
			<div class="container-fluid">
				<form action="update.php" method="post" class="form-neon" autocomplete="off">
					<fieldset>
							...
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[0-9()+]{1,20}" class="form-control" name="empleado_numero" id="cliente_nombre" maxlength="40" required value="<?php echo $row['empleado_numero']  ?>">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_nombre" class="bmd-label-floating">Nombre</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="empleado_nombre" id="cliente_nombre" maxlength="40" required value="<?php echo $row['empleado_nombre']  ?>">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_apellido" class="bmd-label-floating">Primer Apellido</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="empleado_apellido" id="cliente_apellido" maxlength="40" required value="<?php echo $row['empleado_apellido']  ?>">
									</div>
								</div>
                                <div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_apellido" class="bmd-label-floating">Segundo Apellido</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="empleado_apellido2" id="cliente_apellido" maxlength="40" required value="<?php echo $row['empleado_apellido2']  ?>">
									</div>
								</div>
                                <div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_apellido" class="bmd-label-floating">Area</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="empleado_area" id="cliente_apellido" maxlength="40" required value="<?php echo $row['empleado_area']  ?>">
									</div>
								</div>
                                <div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_apellido" class="bmd-label-floating">Cargo</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="empleado_cargo" id="cliente_apellido" maxlength="40" required value="<?php echo $row['empleado_cargo']  ?>">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_telefono" class="bmd-label-floating">Teléfono</label>
										<input type="text" pattern="[0-9()+ ]{1,20}" class="form-control" name="empleado_telefono" id="cliente_telefono" maxlength="20" required value="<?php echo $row['empleado_telefono']?>">
									</div>
								</div>
                                <div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_telefono" class="bmd-label-floating">Extension</label>
										<input type="text" pattern="[0-9()+ ]{1,20}" class="form-control" name="empleado_ext" id="cliente_telefono" maxlength="20" required value="<?php echo $row['empleado_ext']  ?>">
									</div>
								</div>
								<div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <select class="form-control" type="text" name="empleado_direccion" required>
                                            <option value="<?php echo $row['empleado_direccion']  ?>" selected="" disabled="">Empresa</option>
