...
if(isset($_GET['enviar'])){
  $busqueda = $_GET['busqueda'];
	...
	{
		$where="WHERE dispositivo LIKE'%".$busqueda."%' OR asignacion LIKE'%".$busqueda."%'
    OR serie LIKE'%".$busqueda."%' OR mac LIKE'%".$busqueda."%' OR marca  LIKE'%".$busqueda."%' OR modelo  LIKE'%".$busqueda."%' OR ram LIKE'%".$busqueda."%' OR tprocesador LIKE'%".$busqueda."%' OR procesador LIKE'%".$busqueda."%' OR estado LIKE'%".$busqueda."%' OR detalles LIKE'%".$busqueda."%' OR fecha LIKE'%".$busqueda."%'";
	}
...
$conexion=mysqli_connect("localhost","root","","invcudec");               
$SQL="SELECT dispositivo, serie, mac, marca, modelo, ram, tprocesador, procesador, estado, fecha, asignacion, detalles FROM item $where";
