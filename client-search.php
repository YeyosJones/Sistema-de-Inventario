				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						...
						<li>
							...
							<ul>
								<li>
									<a href="client-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar Empleados</a>
								</li>
								<li>
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					...
					<li>
						<a class="active" href="client-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR EMPLEADO</a>
					</li>
				</ul>	
			</div>
...
if(isset($_GET['enviar'])){
  $busqueda = $_GET['busqueda'];
	...
	{
		$where="WHERE empleado_numero LIKE'%".$busqueda."%' OR empleado_nombre  LIKE'%".$busqueda."%'
    OR empleado_apellido  LIKE'%".$busqueda."%' OR empleado_apellido2  LIKE'%".$busqueda."%' OR empleado_area  LIKE'%".$busqueda."%' OR empleado_cargo  LIKE'%".$busqueda."%' OR empleado_telefono  LIKE'%".$busqueda."%' OR empleado_ext  LIKE'%".$busqueda."%' OR empleado_direccion  LIKE'%".$busqueda."%'";
	}
...
$conexion=mysqli_connect("localhost","root","","invcudec");               
$SQL="SELECT empleado_numero, empleado_nombre, empleado_apellido, empleado_apellido2, empleado_area, empleado_cargo, empleado_telefono, empleado_ext, empleado_direccion FROM employee $where";
...
<tr class="text-center">
    <td><?php echo $fila['empleado_numero'] ?></td>
	<td><?php echo $fila['empleado_nombre'] ?></td>
	<td><?php echo $fila['empleado_apellido'] ?></td>
    <td><?php echo $fila['empleado_apellido2'] ?></td>
    <td><?php echo $fila['empleado_area'] ?></td>
    <td><?php echo $fila['empleado_cargo'] ?></td>
    <td><?php echo $fila['empleado_telefono'] ?></td>
    <td><?php echo $fila['empleado_ext'] ?></td>
	<td><?php echo $fila['empleado_direccion'] ?></td>
