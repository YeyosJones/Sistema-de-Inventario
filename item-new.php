...
if ($varrol == 'Visualizador') {
     ?> 
     "<script> alert('Permisos de Administrador o Editor Necesarios.');window.location= 'item-listV.php' </script>";
     <?php
     die();
 }
?>
...
<body>
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <!--CONTENT-->
            <div class="container-fluid">
				<form method="post" action="item_new.php" name="formulario1" class="form-neon" autocomplete="off">
					<fieldset>
							...
							<div class="row">
								...
								<div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <select class="form-control" name="dispositivo" id="dispositivo" onchange="cambia(), cambiaa(), cambiaaa(), cambi()" required>
                                            <option value="" selected="" disabled="">Tipo de Dispositivo</option>
				                            <option value="Acces_Point">Acces Point</option>
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}" class="form-control" name="serie" id="item_nombre" maxlength="140" required>
									</div>
								</div>
                                ...
                                <div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ][^'\x22]{1,140}" class="form-control" name="mac" id="mac" maxlength="140" required>
									</div>
								</div>
                               ...
                               <div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}" class="form-control" name="modelo" id="modelo" maxlength="140" required>
									</div>
								</div>
                               <div class="col-12 col-md-4">
                                  <div class="form-group">
                                        <select class="form-control" name="ram" required>
				                        <option value="Memoria Ram">Memoria Ram
			                            </select>
                                    </div> 
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        <select class="form-control" name="tprocesador" onchange="cambiar()"> 
                                            <option value="Procesador">Tipo de Procesador
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										<select class="form-control" name="estado" required>
                                            <option value="" selected="" disabled="">Estado de Dispositivo</option>
                                ...
                                <div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9()- ]{1,190}" class="form-control" name="asignacion" id="item_detalle" maxlength="190" required>
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="item_detalle" class="bmd-label-floating">Detalles</label>
										<input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9()- ]{1,190}" class="form-control" name="detalles" id="item_detalle" maxlength="190" required>
									</div>
								</div>
							</div>
						</div>
					...
					<p class="text-center" style="margin-top: 40px;">
						...
						&nbsp; &nbsp;
						<button type="submit" class="btn btn-raised btn-info btn-sm" name="registeri"><i class="far fa-save"></i> &nbsp; GUARDAR</button>
					</p>
				</form>
			</div>
        </section>
