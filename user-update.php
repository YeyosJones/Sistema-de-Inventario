...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<!-- Content -->
			<div class="container-fluid">
				<form action="update3.php" method="post" autocomplete="off">
					<fieldset>
							...
							<div class="row">
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="name" id="usuario_nombre" maxlength="35" required value="<?php echo $row['name']  ?>">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_apellido" class="bmd-label-floating">Primer Apellido</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="apellido" id="usuario_apellido" maxlength="35" required value="<?php echo $row['apellido']  ?>">
									</div>
								</div>
                                <div class="col-12 col-md-4">
									<div class="form-group">
										<label for="usuario_apellido" class="bmd-label-floating">Segundo Apellido</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,35}" class="form-control" name="apellido2" id="usuario_apellido" maxlength="35" required value="<?php echo $row['apellido2']  ?>">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" pattern="[a-zA-Z0-9]{1,35}" class="form-control" name="usu" id="usuario_usuario" maxlength="35" required value="<?php echo $row['usu']  ?>">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="usuario_email" class="bmd-label-floating">Email</label>
										<input type="email" class="form-control" name="email" id="email" maxlength="70" required value="<?php echo $row['email']  ?>">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="password" class="form-control" name="usuario_clave_2" id="usuario_clave_2" maxlength="200" required >
									</div>
								</div>
							</div>
						</div>
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									...
									<div class="form-group">
										<select class="form-control" name="rol" value="<?php echo $row['rol']  ?>" required>
